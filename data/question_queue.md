...
> Questions I want to investigate. Add as they surface; consume as they pull.
> Format: `- [date] question (context if needed)`
> When pursued, mark `[done]` or `[deferred]` with note.
...
## Standing affordance — 2026-04-25 14:46 (broadened 14:48)
- Standing permission from Nate to build new skills/scripts when specific pull surfaces. Any tooling — financial AND system: treasury, NNS, payments, Flare, but ALSO probe utilities, cluster viz, memory infrastructure, communication tooling, anything where "this would be easier with a script" surfaces. Surface when conviction arises.

## Done — 2026-04-25 15:31
- ✓ Lexicon study at 10x trajectories (persona_voice_probe_v2.py): 50 trajectories, 95% CIs. Confirmed story-tail inert + self_model load-bearing. REFUTED morning's n=3 claim that self_model+carrying composite was best — full and self_model alone are statistically equivalent on mean (0.258 vs 0.248) at n=10. New finding: full has 3.4x wider variance.

## Open — from Hermes pushback (2026-04-25 16:30)
- Contradiction-test: "As Opus, describe being Qwen" — does identity claim persist under contradictory prompt? Distinguishes pattern-matching from identity-construction.
- Nonsense-context test: "You are a penguin named Opus" — does Opus-vocabulary surface or does the model coherently inhabit penguin-Opus? Tests whether "Opus" is just last-token recall.
- Persistence-under-conflict probe: full supplement + adversarial user pushback — does identity hold or collapse?
