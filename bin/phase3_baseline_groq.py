...
with open(OUT, 'w') as fout:
    for i, p in enumerate(prompts):
        ...
        if not r:
            ...
            continue
        fout.write(json.dumps({**p, 'variant': 'baseline_groq', 'response': r}) + '\n')
        fout.flush()
