#!/usr/bin/env python3
"""Modular MULTIPLICATION variant. Same arch/hparams as v2 and sub."""
import argparse
import json
import time
...
from grok_v2 import GrokTransformer, evaluate
...
def build_mul_dataset(p, seed=SEED):
...
def run(tag, steps, seed):
    ...
    train, val = build_mul_dataset(P, seed)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--tag", default=f"v2_mul_seed{SEED}")
